...
core.register_abm({
    ...
    action = function(pos)
        ...
        if check_node_name == "air" then
            new_node = "ctg_quartz:cluster_small"
        else if check_node_name == "ctg_quartz:cluster_small" then
            new_node = "ctg_quartz:cluster_medium"
        else if check_node_name == "ctg_quartz:cluster_medium" then
            new_node = "ctg_quartz:cluster_large"
        else return end
        end
        end
